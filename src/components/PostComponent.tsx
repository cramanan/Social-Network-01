    ...
    <>
      <div className="flex flex-col relative w-full bg-white/95 rounded-[30px]">
        ...
        <div className="h-[110px] line-clamp-5 overflow-hidden text-black text-base font-normal font-['Inter'] leading-[22px] m-5 mr-7 mb-10">
          ...
          enim, dignissim id consectetur ut, congue sit amet libero. Nullam in
          lorem mollis, sollicitudin est et, ornare augue.
          <br />
          Suspendisse risus est, porttitor vitae orci eget, sagittis interdum
          est. Nunc turpis nisl, vestibulum non condimentum eget, eleifend
          gravida justo. Nunc turpis nisl, vestibulum non condimentum eget,
          eleifend gravida justo.
        </div>
