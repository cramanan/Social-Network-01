...
const SideNavMenu = () => {
    ...
    const toggleSideNav = () => {
        ...
        if (!isOpen) {
            document
                .getElementById("friendInviteList")
    ...
    return (
        <nav
            id="sideNav"
            className="w-[267px] h-[667px] relative bg-white/25 rounded-r-[25px] border-r-2 border-y-2 border-[#bfbfbf] px-5 py-7 -translate-x-44 duration-300 ease-in-out select-none"
        ...
        >
            <ul className="h-full flex flex-col justify-between">
                <li>
                    ...
                    >
                        {isOpen ? <BackSideBarLeft /> : <BackSideBarRight />}
                    </button>
                </li>
