...
const Chat = () => {
  ...
  return (
    <>
      <nav
        id="chat-nav"
        className="w-72 h-12 flex bg-white bg-opacity-40 m-3 border border-neutral-400 rounded-b-3xl px-7"
      ...
      <div
        id="user-list"
        className={`
          absolute right-3 mt-20 transition-all duration-300 ease-in-out
          ${
            isUserListOpen
