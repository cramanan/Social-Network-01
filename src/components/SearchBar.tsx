...
const SearchBar = ({ id }) => {
    return (
        <div className="flex">
            ...
            <input id={id} type="search" className="w-80 h-8 border rounded-r-3xl pr-2 border-l-0 border-white bg-white bg-opacity-40 focus:outline-none" placeholder="Search" aria-label="Search" />
        </div>
    )
}
