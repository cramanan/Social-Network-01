  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-gray-100">
      <div className="flex flex-col md:flex-row w-full max-w-6xl h-full md:h-[748px] relative">
        <div
          className={`w-full md:w-1/2 h-1/2 md:h-full relative bg-white/90 shadow border border-white backdrop-blur-[53px] flex items-center justify-center transition-transform duration-500 ${
            isSignUp
              ? "translate-x-full rounded-tr-[20px] rounded-br-[20px]"
        ...
        <div
          className={`w-full md:w-1/2 h-1/2 md:h-full relative bg-gradient-to-bl from-[#1667e0] to-[#e492e5] shadow border border-white backdrop-blur-[53px] flex flex-col justify-start items-center p-4 md:p-8 transition-transform duration-500 ${
            isSignUp
              ? "-translate-x-full rounded-tl-[20px] rounded-bl-[20px]"
