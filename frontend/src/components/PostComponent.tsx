            ...
            <div className="flex flex-col relative w-full bg-white/95 xl:rounded-[30px]">
                ...
                {post.images.length > 0 && (
                    <p className="w-fit mx-5 mb-0">
                        {post.images.map((src, idx) => (
                            <a href={src} key={idx} target="_blank" rel="noopener noreferrer">
                                <Image
                                    src={src}
                                    width={100}
                                    height={100}
                ...
                <div className="h-[58px] pl-px pr-3 pt-[11px] pb-[7px] bg-[#f2eeee] rounded-[10px] gap-2 items-center inline-flex mx-5 my-2">
                    <div className='w-full flex flex-row items-center gap-2'>
                        ...
                        <input type='text' placeholder='Enter your comment' className="w-full h-[30px] text-black text-xl font-extralight font-['Inter'] bg-white/0"></input>
                    </div>
