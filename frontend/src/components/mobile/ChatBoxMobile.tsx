...
export const ChatBoxMobile = () => {
    return (
        <>
            <div
                id="chatBox"
                className="w-full h-full relative bg-[#fbfbfb] rounded-[25px] flex flex-col"
            >
                <div className="w-full h-[50px] relative bg-[#445ab3]/20 rounded-tl-[25px] rounded-t-[25px] border-b border-black flex flex-row items-center p-2">
                    <BackIcon />
                </div>
